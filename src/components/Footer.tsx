...
const Footer = () => (
  <footer className="footer">
    <div className="footer__links">
      ...
      <a href={`mailto:${resumeData.basics.email}`} className="footer__link">
        <MailIcon /> {resumeData.basics.email}
      </a>
    </div>
    <p className="footer__copy">
      © {new Date().getFullYear()} {resumeData.basics.name} · Built with React &amp; Three.js
    </p>
  </footer>
);
